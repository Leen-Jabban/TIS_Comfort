...
parent_dir = r'PATH TO WHERE RESULTS WILL BE SAVED'
...
for F in Frequencies: 
    ...
    Nerve='Median Nerve Motor Axon'
    Axon_name=Nerve +'_neuron'

    #Create an hdf5 file to store the data 
    save_here=os.path.join(path,(str(F)+".hdf5"))
    ...
    scale=1
    ratio_initial=[0.5,0.5]*sim_settings['Magnitude']
    Neuro_setup={
    ...
    #Save the results of the node before last 
    Axon_name='Main'
